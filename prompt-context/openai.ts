      ...
      messages: [
        {
          ...
          content: [
            ...
            "",
            "### 목표",
            "- 체크리스트 질문을 transcript 근거로만 평가한다.",
            "",
            "### 핵심 원칙",
            "- 근거(evidence)가 **명시적으로** 있으면 Yes, 없으면 No.",
        ...
        },
        {
          ...
          content: JSON.stringify({
            instructions: [
              "### 작업 지시",
              "- 아래 questions의 각 항목에 대해 하나의 답변을 반환한다.",
              "- questionId는 입력과 동일하게 유지한다.",
              "",
              "### 판정 기준",
              "- evidence가 **명시적**으로 있으면 Yes.",
              "- evidence가 없거나 모호/간접/추론이면 No.",
              ...
              "### 출력 형식",
              "- JSON 배열만 출력한다.",
              "- 각 항목 형식: {\"questionId\":\"...\",\"aiAnswer\":\"Yes|No\",\"evidence\":[\"mm:ss\",...]}",
              "",
              "### 언어",
